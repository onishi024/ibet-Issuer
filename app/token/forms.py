...
class IssueTokenForm(Form):
    ...
    interestPaymentDate = [StringField("利払日１", validators=[]),
        StringField("利払日２", validators=[]),
        StringField("利払日３", validators=[]),
        StringField("利払日４", validators=[]),
        StringField("利払日５", validators=[]),
        StringField("利払日６", validators=[]),
        StringField("利払日７", validators=[]),
        StringField("利払日８", validators=[]),
        StringField("利払日９", validators=[]),
        StringField("利払日１０", validators=[]),
        StringField("利払日１１", validators=[]),
        StringField("利払日１２", validators=[])
    ]
    # interestPaymentDate1 = StringField("利払日１", validators=[])
    # interestPaymentDate2 = StringField("利払日２", validators=[])
    # interestPaymentDate2 = StringField("利払日３", validators=[])
    # interestPaymentDate2 = StringField("利払日４", validators=[])
    # interestPaymentDate2 = StringField("利払日５", validators=[])
    # interestPaymentDate2 = StringField("利払日６", validators=[])
    # interestPaymentDate2 = StringField("利払日７", validators=[])
    # interestPaymentDate2 = StringField("利払日８", validators=[])
    # interestPaymentDate2 = StringField("利払日９", validators=[])
    # interestPaymentDate2 = StringField("利払日１０", validators=[])
    # interestPaymentDate2 = StringField("利払日１１", validators=[])
    # interestPaymentDate2 = StringField("利払日１２", validators=[])
