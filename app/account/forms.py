...
class PasswordChangeForm(Form):
    password = PasswordField('新しいパスワード', [ DataRequired('新しいパスワードが入力されていません。'), EqualTo('confirm', message='パスワードが一致しません。') ])
